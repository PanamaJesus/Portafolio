...
import nflLogo from './assets/nfl2.png'; 
...
const App = () => {
  return (
    <NavigationContainer>
      <Stack.Navigator>
        <Stack.Screen name="NFL Menu" component={MenuScreen} options={{ title: 'NFL Todos los pendientes' }} />
                
        <Stack.Screen name="TodoDetails" component={TodoDetailsScreen} options={{ title: 'Detalles del los Pendientes' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
};
